(function (global, factory) {
  ...
  class Aim {
    constructor(imageData, _aimType, updatedAimId) {
      ...
      _defineProperty(this, "addMarkupEntity", (type, shapeIndex, points, imageUid, frameNum) => {
        var obj = {};
        obj["includeFlag"] = {
          value: true
        };
  ...
  function createOfflineAimSegmentation(segmentation, userInfo) {
    ...
    delete aim.imageAnnotations.ImageAnnotation[0].imageAnnotationStatementCollection; // add name, comment and segmentation
